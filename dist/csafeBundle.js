(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.csafe = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
require('./styles.css');
var webSocketUrl = 'wss://services.test.csafe.de/api/registration/wss';
var csafeTempUid = null, aesKey = null, csafeButton, csafeAutoFillBtn, qrCodeOverlay;
var enableLogin = false, enableRegister = false;
var csafeLoginData, csafeRegisterData;
function postForward(path, params) {
...
function shortId(len) {
    var length = len ? len : 9, text = '', possible = '23456789ABCDEFGHJKLMNPRSTUVWXYZabcdefghijkmnopqrstuvwxyz';
...
function convertDataURIToBinary(base64) {
    var raw = window.atob(base64), rawLength = raw.length, array = new Uint8Array(new ArrayBuffer(rawLength));
    for (var i = 0; i < rawLength; i++) {
        array[i] = raw.charCodeAt(i);
    }
    return array;
}
function decrypt(base64, key, aesCounter) {
    //decrypted text in utf8
    console.log(convertDataURIToBinary(base64));
    var encryptedBytes = convertDataURIToBinary(base64), //aesjs.utils.hex.toBytes(hexString),
    aesCtr = new aesjs.ModeOfOperation.ctr(key, new aesjs.Counter(aesCounter)), decryptedBytes = aesCtr.decrypt(encryptedBytes);
...
function csafeButtonClick() {
    if (csafeTempUid === null) {
        ...
        QRCode.toCanvas(document.getElementById('qrCode'), csafeLoginData.webSocketSessionToken, function (error) {
            if (error)
                console.error(error);
            console.log('success!');
        });
...
function getQrCodeContent(webSocketSessionToken) {
    var base64String = btoa(String.fromCharCode.apply(String, __spread(new Uint8Array(aesKey.key))));
...
function loginWebsocket() {
    ...
    if ('WebSocket' in window) {
        var ws = new WebSocket(webSocketUrl + "?token=" + csafeLoginData.webSocketSessionToken + "&login=yes");
...
function registerWebsocket() {
    if ('WebSocket' in window) {
        var ws = new WebSocket(webSocketUrl + "?token=" + csafeRegisterData.webSocketSessionToken);
        ws.onmessage = function (event) {
            var encryptedRegistrationData = JSON.parse(event.data).encryptedText, decryptData = decrypt(encryptedRegistrationData, aesKey.key, aesKey.counter), registrationData = JSON.parse(decryptData);
...
function csafeAutoFillBtnClick() {
    var qrContent = getQrCodeContent(csafeRegisterData.webSocketSessionToken);
    ...
    QRCode.toCanvas(document.getElementById('qrCodeForAutoFill'), qrContent, function (error) {
        if (error)
            console.error(error);
        console.log('success!');
    });
...
function csafeLoginInit(initPara) {
...
function csafeInitRegister(webSessionToken, qrCodeElementId, resultCallback) {
    aesKey = getAesKey();
    csafeRegisterData = {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (enableRegister) {
        ...
        csafeAutoFillBtn.setAttribute('style', 'margin: 10px 0; ' +
...
},{"./styles.css":34,"aes-js":2,"qrcode":6}],2:[function(require,module,exports){
...
},{"../utils/buffer":33,"./polynomial":22}],25:[function(require,module,exports){
var numeric = '[0-9]+'
...
},{"buffer":36,"isarray":5}],34:[function(require,module,exports){
var css = ".csafeBtn {\n  margin: 10px 0;\n  background-color: #2699fb;\n  color: white;\n  width: 100%;\n  border: none;\n  border-radius: 4px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.buttonText {\n  margin: 0;\n  padding: 8px 16px;\n  line-height: 1.75;\n  letter-spacing: 0.02857em;\n  font-size: inherit;\n  font-weight: 500;\n}\n.circle-loader {\n  margin-left: 1em;\n  border: 1px solid rgba(0, 0, 0, 0.2);\n  border-left-color: #ffffff;\n  animation: loader-spin 1.2s infinite linear;\n  position: relative;\n  display: inline-block;\n  vertical-align: top;\n  border-radius: 50%;\n  width: 2em;\n  height: 2em;\n}\n.init-loader {\n  /*margin-bottom: 1em;*/\n  border: 1px solid rgba(0, 0, 0, 0.2);\n  border-left-color: #ffffff;\n  animation: loader-spin 1.2s infinite linear;\n  position: relative;\n  display: inline-block;\n  vertical-align: top;\n  border-radius: 50%;\n  width: 2em;\n  height: 2em;\n  margin: 0.5em;\n}\n.load-complete {\n  -webkit-animation: none;\n  animation: none;\n  border-color: #ffffff;\n  transition: border 500ms ease-out;\n}\n.checkmark {\n  display: none;\n}\n.checkmark.draw:after {\n  animation-duration: 800ms;\n  animation-timing-function: ease;\n  animation-name: checkmark;\n  transform: scaleX(-1) rotate(135deg);\n}\n.checkmark:after {\n  opacity: 1;\n  height: 0.8em;\n  width: 0.5em;\n  transform-origin: left top;\n  border-right: 2px solid #ffffff;\n  border-top: 2px solid #ffffff;\n  content: '';\n  left: 0.4em;\n  top: 1em;\n  position: absolute;\n}\n@keyframes loader-spin {\n  0% {\n    transform: rotate(0deg);\n  }\n\n  100% {\n    transform: rotate(360deg);\n  }\n}\n@keyframes checkmark {\n  0% {\n    height: 0;\n    width: 0;\n    opacity: 1;\n  }\n\n  20% {\n    height: 0;\n    width: 0.5em;\n    opacity: 1;\n  }\n\n  40% {\n    height: 0.8em;\n    width: 0.5em;\n    opacity: 1;\n  }\n\n  100% {\n    height: 0.8em;\n    width: 0.5em;\n    opacity: 1;\n  }\n}\n.overlay {\n  position: fixed;\n  /*background-color: rgba(0, 0, 0, 0.12);*/\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: 2000;\n}\n"; (require("browserify-css").createStyle(css, { "href": "styles.css" }, { "insertAt": "bottom" })); module.exports = css;
},{"browserify-css":3}],35:[function(require,module,exports){
'use strict'
